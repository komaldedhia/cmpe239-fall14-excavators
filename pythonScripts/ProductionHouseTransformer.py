...
j = open('E:/239 mining/Project/Goudamy/Transformed/prodHouseTransform.csv','wb')
csv_f = csv.reader(f)
writer = csv.writer(j)
#actList=[0,0,0,0,0,0]
lineCnt = 0
    ...
    if lineCnt > 1:
        ...
        for prodHouse in prodList:
            ...
            if (cnt == 1):
                ...
                elif "New Line"  in productioHouse:
                    productioHouse = "NLine"
                ...
                doc = db.command("text", "prodHouse",search=productioHouse, project={"_id": 1})
